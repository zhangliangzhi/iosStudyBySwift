...
extension TipsSwift
{
    ...
    public class func showCenterWithText(_ text: String) {
        ...
        TipsSwift.showCenterWithText(text, duration:ToastDispalyDuration)
    }
    ...
    public class func showTopWithText(_ text:String) {
        TipsSwift.showTopWithText(text, topOffset:ToastSpace, duration:ToastDispalyDuration)
    }
    ...
    public class func showTopWithText(_ text:String, duration:CGFloat) {
        TipsSwift.showTopWithText(text, topOffset:ToastSpace, duration:duration)
    }
    ...
    public class func showTopWithText(_ text:String,topOffset:CGFloat) {
        TipsSwift.showTopWithText(text, topOffset:topOffset, duration:ToastDispalyDuration)
    }
    ...
    public class func showBottomWithText(_ text:String) {
        TipsSwift.showBottomWithText(text, bottomOffset:ToastSpace, duration:ToastDispalyDuration)
    }
    ...
    public class func showBottomWithText(_ text:String,duration:CGFloat) {
        TipsSwift.showBottomWithText(text, bottomOffset:ToastSpace, duration:duration)
    }
    ...
    public class func showBottomWithText(_ text:String,bottomOffset:CGFloat) {
        TipsSwift.showBottomWithText(text, bottomOffset:bottomOffset, duration:ToastDispalyDuration)
    }
    ...
    public class func showBottomWithText(_ text:String,bottomOffset:CGFloat,duration:CGFloat) {
        let toast: TipsSwift = TipsSwift(text: text)
        toast.duration = duration
